...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-cart-service-dev-key')
...
DATABASES = {
    'default': {
        ...
        'USER': os.environ.get('DATABASE_USER', 'cart_admin'),
        'PASSWORD': os.environ.get('DATABASE_PASSWORD', 'cart_secret_2026'),
